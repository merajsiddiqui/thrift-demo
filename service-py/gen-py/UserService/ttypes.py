...
class User(object):
    ...
    def __init__(self, name=None, id=None, active=None,):
        self.name = name
        self.id = id
        self.active = active
...
class InvalidUser(TException):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('InvalidUser')
...
all_structs.append(InvalidUser)
InvalidUser.thrift_spec = (
    None,  # 0
